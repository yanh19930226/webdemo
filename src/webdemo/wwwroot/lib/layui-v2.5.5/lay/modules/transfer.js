...
layui.define(['laytpl', 'form'], function (exports) {
    ...
    var $ = layui.$
        ...
        , TPL_MAIN = ['<div class="layui-transfer layui-form layui-border-box" lay-filter="LAY-transfer-{{ d.index }}">'
            ...
            , '<button type="button" class="layui-btn layui-btn-sm layui-btn-primary layui-btn-disabled layui-btn-transfer-next" data-index="0">'
            , '<i class="layui-icon layui-icon-next"></i>'
            , '</button>'
            , '<button type="button" class="layui-btn layui-btn-sm layui-btn-primary layui-btn-disabled  layui-btn-transfer-prev" data-index="1">'
    ...
    Class.prototype.events = function () {
        ...
        that.layBtn.on('click', function () {
            ...
            if (_index == 0 && that.config.createInput) {
